...
import{Card,Rate,Button,Modal,Timeline} from 'antd'
import { Fragment } from 'react'

const DegreeStatusCard=({courseName,totalCost,type,offlinetotal,totalNumberCourses,
    durationFrom,durationCrit,degreeType,hoursPerWeek,Dep,rev,
     ...
     courseSpecification,online,offline,compulsory,optional,DegreeStatus,onlinetotal,coursetotal})=>{
...
<Card className='CourseCards'  hoverable
  ...
  actions={[
    ...
    <Button type='primary'> {DegreeStatus}</Button>,
...
export default DegreeStatusCard

...
const EnrolledDegree=()=>{
    return(
        <Fragment>
            <DegreeStatusCard courseName={'Theory'} totalCost={'400/$'} type={'certifcate'} offlinetotal={3} totalNumberCourses={'8'}
    durationFrom={'duration start'} durationCrit={'end dur'} degreeType={'degree type'} hoursPerWeek={'20'} Dep={'CS'} rev={'3000'}
     ...
     courseSpecification={'sopecs'} online={'3'} offline={'4'} compulsory={'5'} optional={'6'} DegreeStatus={'Enrolled'} onlinetotal={'4'} 
     coursetotal={'10'}/>
     <br/>

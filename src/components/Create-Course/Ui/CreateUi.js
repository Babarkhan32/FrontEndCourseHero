    ...
    searchPlaceholder="Search for a language" /> */}
                            ...
                            >
                              <TextArea
                                ...
                                showCount
                                maxLength={100}
                                placeholder="Brielfy explain the course breakdown"
                              />
                            </Form.Item>
                            ...
                            {props.resume ? (
                              <div className="row">
                                <span class="col-5 mr-3 mt-1">
                                  <h6 style={{ color: "#096dd9" }}>
                                    {props.resume && props.resume.name}
                                  </h6>
                                </span>
                                <Button
  ...
  >
    <Option value="$" label="$">
       $
                            ...
                            <h6 className="BlkTitle mtt-15">
                              Is this course is a part of any other
                              program/degree ?{" "}
                            </h6>
                            ...
                            <Form.Item
                              ...
                              rules={[{ required: false }]}
                            >
                              <Select placeholder="Specify Course">
                            ...
                            <Form.Item
                              noStyle
                              shouldUpdate={(prevValues, currentValues) =>
                                prevValues.part !== currentValues.part
                              }
                            >
                              {({ getFieldValue }) => {
                                return getFieldValue("part") === "Yes" ? (
                                  ...
                                  >
                                    ...
                                    >
                                      {({ getFieldValue }) => {
                                        return getFieldValue("ProgramType") ===
                                          "Interdisciplinary" ? (
                                          <div
                                            name="customizeType"
                                            rules={[{ required: true }]}
                                          >
                                            ...
                                            <Form.Item
                                              name="programAdditionalSubject1"
                                              rules={[{ required: true }]}
                                            >
                                              <Input type="text" />
                                            </Form.Item>
                                            ...
                                            <Form.Item
                                              name="programAdditionalSubject2"
                                              rules={[{ required: true }]}
                                            >
                                              <Input type="text" />
                                            </Form.Item>
                                            ...
                                            <Form.Item
                                              name="programAdditionalSubject3"
                                              rules={[{ required: true }]}
                                            >
                                              <Input type="text" />
                                            </Form.Item>
                                        ...
                                        <>
                                          {fields.map((field) => (
                                            ...
                                            >
                                              ...
                                              >
                                                <Select placeholder="Select Course Type">
                                                  <Option value="ProgramDisciplinary">
                                                    Disciplinary Course
                                                  </Option>
                                                  <Option value="ProgramInterdisciplinary">
                                                    Interdisciplinary Course
                                                  </Option>
                                                </Select>
